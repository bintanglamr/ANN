...
Original file is located at
    https://colab.research.google.com/drive/1HH7b7Ur3nxEbFxzwjPMq_qkS1q6IxBjO
...
"""# Model Building (FOR ANN ONLY)"""

# Assuming df is your original dataset with features and target
X = df[['SunZenith_KMU', 'Ambient_Pressure', 'Water', 'AOD', 'wv_500', 'CI_Beyer']]  # Input features
y = df['GHI_Average']  # Target variable

# Reshape X for ANN input (no need to reshape y)
...
# Train the model
ann_history = ann_model.fit(X_train, y_train, epochs=50, batch_size=32, validation_split=0.1, shuffle=False)
...
df_metrics_ANN = pd.DataFrame(metrics)
